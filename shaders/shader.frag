...
void main() {
  ...
  else
  {
    ...
    vec4 texColor =
      0.6 * vec4(hi, hi, hi, 1.) +
      0.1 * vec4(hi, lo, lo, 1.) * spot(vec2(0.25, 0.25)) +
      0.1 * vec4(lo, hi, lo, 1.) * spot(vec2(0.25, 0.75)) +
      0.1 * vec4(lo, lo, hi, 1.) * spot(vec2(0.75, 0.25)) +
      0.1 * vec4(hi, lo, lo, 1.) * spot(vec2(0.75, 0.75));
